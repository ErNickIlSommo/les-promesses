  ...
  return (
    <div id="video-lp" className="Home flex flex-col gap-10 md:gap-36">
      ...
      <div className="relative font-light">
        <div className=" w-full h-[800px] absolute z-20 flex justify-center items-center">
          <div className=" w-full md:w-3/5 md:bg-[#D9D8D7] text-center text-white md:text-black p-6 py-10">
            ...
            <p className="text-4xl md:text-7xl uppercase">
              {noCollection.title}
            </p>
            <p className="text-4xl md:text-7xl pb-2 font-medium uppercase">
              {noCollection.title2}
            </p>
            <p className="text-base px-10 md:px-20 lg:px-24">
              {noCollection.description}
            </p>
          </div>
        </div>
      ...
      <div className="font-light">
        <p className="text-3xl md:text-7xl text-end mb-5 md:mb-10 uppercase">
          {thirdStep.title}
        </p>
        <div className="flex flex-col-reverse md:flex-row gap-10">
          <div className="w-full md:w-1/4">
            <div className="mb-10">
              <p className="font-semibold underline">
                {thirdStep.faqs.faq1.question}
              </p>
              <p className="mb-2.5 italic">{thirdStep.faqs.faq1.answer}</p>
            </div>
            <div className="mb-10">
              <p className="font-semibold underline">
                {thirdStep.faqs.faq2.question}
              </p>
      ...
      >
        <div className="w-full lg:w-1/3 text-left pb-10 pe-6">
          <p className="text-4xl md:text-6xl uppercase text-end">
            {presentation.title}
          </p>
        ...
        <div className="w-full h-full flex align-bottom lg:w-1/3 pb-10 ps-6">
          <p className="text-base mt-32 pb-10 pe-6">
            ...
            <br />
            {presentation.description.line2}
            <br />
            <br />
            {presentation.description.line3}
            <br />
            <br /> {presentation.description.line4}
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div className="w-full h-full lg:w-1/3 items-center">
          ...
          <p className="text-4xl md:text-7xl pb-2 font-medium text-center uppercase">
            {contactForm.title2}
          </p>
          <form
            id="sib-form"
            method="POST"
            action="https://217ddafd.sibforms.com/serve/MUIFANAFS4E_YRtmxKHBueYSx7KUIq2JAok0uboMRi7WQArR-KAtFEpzbulcUs0It_RLIC8QYjkF0RtXoHmrKkv7mZdBFqrMYe8UgpZ72AH2nQAxCpUvBffwS0e_dgabBgaaBbP4NxL868kX10p8DX99YYJfVWyXYv7idd8KNnmFe3Vt1et56SrMj3T9X7IaHH-Q0chvHS7S20Td"
          ...
          >
            ...
            <div>
              ...
              <p className="w-full text-gray-800 font-light text-sm mt-1">
                {contactForm.disclamer}
              </p>
            </div>
            <button
              form="sib-form"
              type="submit"
              disabled={!isChecked}
              className="w-full font-bold px-5 py-3 border-2 border-[#A39B98] rounded-sm text-center text-[#000000] uppercase cursor-pointer disabled:opacity-50 disabled:"
            >
              {contactForm.cta}
            </button>
          </form>
