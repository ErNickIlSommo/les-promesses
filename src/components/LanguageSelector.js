...
const LanguageSelector = ({ lan }) =>{
    ...
    return(
        ...
        >
            <div className="">
                <p 
                    className="inline-flex justify-center w-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-indigo-500 select-none cursor-pointer" 
            ...
            {isOpen && (
            <div
                className="w-24 origin-top-right absolute right-0 mt-2 p-3 rounded-sm border border-gray-600 bg-[#D9D8D7]"
