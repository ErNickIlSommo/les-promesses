        ...
        <div className="h-min-[500px] w-full flex flex-col md:flex-row justify-between px-3 md:px-10 py-10 md:py-20 gap-10">  
                ...
                <div className="w-full md:w-1/3 lg:w-1/6">
                    ...
                    <div className="flex flex-col gap-0 uppercase text-sm">
                        ...
                        <Link smooth  className="" to="/gallery">{gallery}</Link>
                        <Link smooth className="" to="/#who">{whoWeAre}</Link>
                        {/* <p>IT</p> */}
                        <Link smooth  to="/#form">{cta}</Link>
                    </div>
                </div>
                <div className="w-full md:w-1/3 lg:w-1/6">
                ...
                <div className="w-full md:w-1/3 lg:w-1/6">
                    ...
                    <div className="flex flex-col gap-0 text-sm">
                        <p>{credits.line1}</p>
                        <p>{credits.line2}</p>
                        <p>{credits.line3} <a href="https://www.raffaelecrocco.com/">{credits.line3b}</a></p>
                        <p>{credits.line4}</p>
                    </div>
                </div>
                <div className="w-full md:w-1/3 lg:w-1/6">
